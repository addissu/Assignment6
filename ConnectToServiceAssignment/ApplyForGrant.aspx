    ...
    <div>
        ...
        <table>
            <tr>
                ...
                <td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Date Is Required" ControlToValidate="UserTextBox"></asp:RequiredFieldValidator></td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <asp:Button ID="SubmitButton" runat="server" Text="Button" OnClick="SubmitButton_Click" /></td>
